        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">EN Sabit İçerikler Düzenle</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php $system->router('admin', 'home'); ?>">Kontrol Paneli</a></li>
                                <li class="breadcrumb-item"><a href="<?php $system->router('admin', 'constant'); ?>">EN Sabit İçeriklerler</a></li>
                                <li class="breadcrumb-item active">EN Sabit İçerikler Düzenle</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h4 class="card-title">EN Sabit İçerikler Düzenle</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <form class="needs-validation mt-2" enctype="multipart/form-data" action="<?php $system->router('admin', 'constant', 'en') ?>" method="POST" novalidate>

                                    <div class="col-xl-10 offset-xl-1 col-md-12 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="detail">EN</label>
